...
class Porta:
    ...
    def verificar_porta(self, jogador):
        ...
        # Verifica se o jogador está na área da primeira porta
...
class Mapa:
    def __init__(self, jogador):
        ...
        self.combate_em_andamento = False  # Adicionada flag para controlar a música
...
############ Desenha os NPCs
        self.npcs = [
            ...
            NPC(300,400, "tutui é o gato mais forte daqui,\nvive na academia", 0, 208, 16, 16, num_quadros=3, intervalo_animacao=0.2),
            ...
            NPC(376,384, "hey toma cuidado,\nexistem gatos perigosos por aqui", 128, 240, 16, 16, num_quadros=3, intervalo_animacao=0.3),
        ...
        self.inimigo = [
                        Inimigo(213, 423, 8, 3, 128, 208, "Minhas patas nao falham!\nVenha se atrever!"),
